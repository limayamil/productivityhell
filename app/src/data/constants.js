export const PERK_POOL = [
  ...
  },
  {
    ...
    tags: ['opening', 'tempo'],
    categoryAffinity: 'any',
    desc: 'The first move of the day lands harder when you make it count.',
    description: 'The first move of the day lands harder when you make it count.',
    effect: { label: '+120 pts on the first task of round 1', kind: 'firstRoundSoftStart', amount: 120 },
  },
  {
    id: 'first-blood-ledger',
    name: 'First Blood Ledger',
    rarity: 'uncommon',
    icon: 'FB',
    trigger: 'first 20 min',
    tags: ['opening', 'speed'],
    categoryAffinity: 'any',
    desc: 'Draw first blood early and the ledger credits the aggression.',
    description: 'Draw first blood early and the ledger credits the aggression.',
    effect: { label: '+100 pts if the first task lands in 20 min', kind: 'earlyRoundCompletion', firstMinutes: 20, amount: 100 },
  },
  {
    id: 'combo-furnace',
    name: 'Combo Furnace',
    ...
    tags: ['combo', 'chain'],
    categoryAffinity: 'any',
    desc: 'Once the round is moving, every extra hit keeps the furnace fed.',
    description: 'Once the round is moving, every extra hit keeps the furnace fed.',
    effect: { label: '+75 pts on the 2nd+ task each round', kind: 'sameRoundCombo', minCompletedBefore: 1, amount: 75 },
  },
  {
    id: 'deadline-draft',
    name: 'Deadline Draft',
    ...
    tags: ['urgent', 'timing'],
    categoryAffinity: 'any',
    desc: 'Catch the pressure wave before the last-minute panic hits.',
    description: 'Catch the pressure wave before the last-minute panic hits.',
    effect: { label: '+30% urgent task base before last 15 min', kind: 'urgentBeforeLastMinute', lastMinutes: 15, percent: 0.3 },
  },
  {
    id: 'paper-cut-engine',
    name: 'Paper Cut Engine',
    rarity: 'epic',
    icon: 'PC',
    trigger: 'short tasks',
    tags: ['quick', 'chain'],
    categoryAffinity: 'any',
    desc: 'Tiny wins become a machine when you keep feeding them in sequence.',
    description: 'Tiny wins become a machine when you keep feeding them in sequence.',
    effect: { label: '+50 pts on short tasks, +20 per short-task chain', kind: 'shortTaskChain', maxDuration: 20, amount: 50, step: 20 },
  },
  {
    id: 'side-quest-flywheel',
    name: 'Side Quest Flywheel',
    rarity: 'legendary',
    icon: 'SQ',
    trigger: 'not urgent',
    tags: ['multiplier', 'optional'],
    categoryAffinity: 'any',
    desc: 'Unforced work compounds quietly until the build starts carrying itself.',
    description: 'Unforced work compounds quietly until the build starts carrying itself.',
    effect: { label: '+0.10x multiplier growth on non-urgent tasks', kind: 'optionalTaskMultiplier', step: 0.1 },
  },
  {
    id: 'attendance-ritual',
    name: 'Attendance Ritual',
    rarity: 'cursed',
    icon: 'AR',
    trigger: 'first task/hour',
    tags: ['rhythm', 'pressure'],
    categoryAffinity: 'any',
    desc: 'Show up every hour and the ritual starts demanding consistency.',
    description: 'Show up every hour and the ritual starts demanding consistency.',
    effect: { label: '+70 pts on each first hourly task, +15 per filled hour streak', kind: 'hourlyParticipation', amount: 70, step: 15 },
  },
];
